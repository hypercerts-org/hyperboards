...
alter table "public"."fraction_sponsor_metadata" enable row level security;
...
alter table "public"."fraction_sponsor_metadata" add constraint "fraction_sponsor_metadata_pkey" PRIMARY KEY using index "fraction_sponsor_metadata_pkey";
